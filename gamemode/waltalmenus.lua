...
WTChoices[2] = {
	...
	[5] = {text = "Attacking", num = 5, chatfunc = function(ply)
		DoRadio(ply, 2, 5)
	end},
	
	[6] = {text = "Enemy down", num = 6, chatfunc = function(ply)
		DoRadio(ply, 2, 6)
	end},
	
	[7] = {text = "Clear", num = 7, chatfunc = function(ply)
		DoRadio(ply, 2, 7)
	end},

	[8] = {text = "I'll follow you", num = 8, chatfunc = function(ply)
		DoRadio(ply, 2, 8)
	end},
	
	[9] = {text = "Let's wait here", num = 9, chatfunc = function(ply)
		DoRadio(ply, 2, 9)
	end}}
...
WTSounds[1] = {
	...
	[6] = {
		...
		[3] = {text = "Hang on, I heard something.", sound = "bot/hang_on_i_heard_something.wav"}},
...
WTSounds[2] = {
	...
	[2] = {
		...
		[5] = {text = "Okay.", sound = "bot/ok.wav"},
		[6] = {text = "Okay.", sound = "bot/ok2.wav"}},
