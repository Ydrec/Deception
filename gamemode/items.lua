...
function GM:RegisterItem(tbl)
	table.insert(Items, {num = tbl.num, Name = tbl.Name, Category = tbl.Category, Description = tbl.Description, Model = tbl.Model, Stats = tbl.Stats, Price = tbl.Price, Weapon = tbl.Weapon, CanBuy = tbl.CanBuy, BuyFunc = tbl.BuyFunc, TeamText = (tbl.TeamText or {"Civilian", "Agent", "VIP"})})
end
