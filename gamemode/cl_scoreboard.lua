...
function GM:HUDDrawScoreBoard()
	...
	stext("'Deception' ver. " .. Ver .. " by Spy (LEETNOOB on FP) and trotskygrad (trotskygrad on FP) ", "TabLarge", X2, Y2 - 34 - scale1, Color(255, 255, 255, 255), Color(0, 0, 0, 255), 1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
